...
import { ArrowPathIcon, FlagIcon, CheckCircleIcon } from '@heroicons/react/24/solid';
        ...
        <div className="overflow-y-auto flex-grow pr-2 -mr-2">
            <ul className="space-y-1">
                {plan.map((section, index) => {
                    ...
                    let itemClasses = "p-2 rounded-md transition-all duration-200 text-sm flex flex-col";
                    if (isCurrent) {
                        ...
                        >
                            <div className="flex justify-between items-start">
                                <div className="flex-1">
                                    <span className={`font-medium ${section.level === 1 ? 'font-bold' : ''}`}>
